...
│
├── __init__.py
├── base_connector.py          # Główna klasa bazowa (rodzic)
├── market_data_handler.py     # Handler danych rynkowych (dziecko)
├── historical_data_handler.py # Handler danych historycznych (dziecko)
├── trade_handler.py           # Handler operacji handlowych (dziecko)
